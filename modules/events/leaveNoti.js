...
module.exports.run = async function({ api, event, Users, Threads }) {
  ...
  const time = moment.tz("africa/egypt").format("DD/MM/YYYY || HH:mm:s");
  const hours = moment.tz("africa/egypt").format("HH");
...
(typeof data.customLeave == "undefined") ? msg = "[⚜️]  {name} رحل عنا  {type}  {session} || {time} الله لا يرجعه 💆🏻‍♀️" : msg = data.customLeave;
